...
public class HttpAspect {
    ...
    @Pointcut("execution(public * auth.controller.*.*(..))")
    public void webLog() {
    }
    ...
    @AfterThrowing(value = "execution(public * auth.controller.*.*(..))", throwing = "e")
    ...
    @Pointcut("execution(public * auth.config.MockLog.printLog(..))")
